...
Run with
    heatflow_red_black_omp.exe 10 10 4 4
...
int main(int argc, char *argv[]) {
    ...
    //printf("Black and white OPENMP takes %f times", end_time - start_time);

    FILE *f = fopen("heatflow_red_black_omp.txt", "w");
    if (f == NULL)
    {
    ...
    printf("Output save to       : heatflow_red_black_omp.txt\n");
